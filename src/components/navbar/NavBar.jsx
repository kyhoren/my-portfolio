...
export default function NavBar() {
    ...
    return (
        <div className="navbar" id="nav">  {/* adding pActive or sActive changes color */}
            <div className="wrapper">
                <div className="left">
                    <a href="#home" className="home">creo.</a>
                </div>
                <div className="middle" id="midnav">  {/* adding pActive or sActive changes color */}
                ...
                <div className="right" id="rightnav"> {/* adding pActive or sActive changes color */}
